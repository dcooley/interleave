...
- **start_indices** - the index of **coordinates** which denotes the start of each geometry (using 0-based indexing)
- **n_coordinates** - the number of coordinates in each geometry

Where 

- an individual coordinate is typically represented as (x, y), although any number of values is accepted (e.g, (x, y, z, m))
