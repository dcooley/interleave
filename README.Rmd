...
- **start_indices** - the index in the **coordinates** vector where each geometry starts.
...
If you imagine two lines represented by two matrices, one with seven rows and the other with 5.
...
- `length( coordinates ) / stride` gives the total number of coordinates 
